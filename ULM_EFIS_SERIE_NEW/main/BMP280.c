...
static i2c_master_dev_handle_t s_bmp280_dev = NULL;
...
{
    if ((s_bmp280_dev == NULL) || (data == NULL) || (len == 0U))
...
esp_err_t bmp280_init(void)
{
    ...
    {
        ESP_RETURN_ON_ERROR(
            efis_i2c_add_device(BMP280_ADDR, &s_bmp280_dev),
            TAG,
            "No se pudo registrar BMP280 en el bus I2C");
    }
