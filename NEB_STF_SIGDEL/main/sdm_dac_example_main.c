...
#define EXAMPLE_SIGMA_DELTA_GPIO_NUM    (5)                 // Select GPIO_NUM_0 as the sigma-delta output pin
...
#define EXAMPLE_SINE_WAVE_FREQ_HZ       (1)               // 100 Hz sine wave, adjust this value to decide the sine wave frequency
