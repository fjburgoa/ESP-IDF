...
//------------------------------------------------------------
// Convierte una frecuencia intermedia freqx entre freq1 y freq2 aplicando una curva Smoothstep de tercer orden.
//
//
//
...
//------------------------------------------------------------
RMT_ENCODER_FUNC_ATTR static size_t rmt_encode_stepper_motor_curve(rmt_encoder_t *encoder, 
...
//------------------------------------------------------------
RMT_ENCODER_FUNC_ATTR static esp_err_t rmt_reset_stepper_motor_curve_encoder(rmt_encoder_t *encoder)
{
    rmt_stepper_curve_encoder_t *motor_encoder = __containerof(encoder, rmt_stepper_curve_encoder_t, base);
