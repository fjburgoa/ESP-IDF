...
extern "C"
{
    ...
    /* Aplica una única configuración base durante el arranque. */
    esp_err_t bno055_apply_vertical_mode(void);

    /**
     * @brief Selecciona explícitamente un modo de operación del BNO055.
     */
    ...
    /**
     * @brief Avanza al siguiente modo de prueba.
     *
     * Secuencia: AMG -> IMUPLUS -> NDOF -> NDOF_FMC_OFF -> AMG.
     */
