...
{   
    ...
    xTaskCreate( vTaskCode2, "TASK2", STACK_SIZE, NULL, 2, &xHandle2 );  //Prioridad 1 
    ...
    while (1) 
    {
        ...
        vTaskDelay(20/portTICK_PERIOD_MS);   //Wait 1 sec
    }
}
