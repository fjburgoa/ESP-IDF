...
Una aplicación en «ESP-Dev-Board» se puede actualizar en tiempo de ejecución descargando una nueva imagen a través de Wi-Fi o Ethernet y flasheándola en una partición OTA. El ESP-IDF ofrece dos métodos para realizar actualizaciones Over The Air (OTA):
